...
class LiveInterviewProvider:
    ...
    def analyze_answer(self, context: dict[str, Any]) -> tuple[InterviewAnalysisAI, dict[str, Any]]:
        instructions = (
            ...
            "Optimize next_best_question for both remaining SAFe practice coverage and applicable enterprise-standard coverage. "
            "Prefer one broad question that gathers evidence for several SAFe practices and standards simultaneously. "
            "Do not ask enterprise standards as a separate questionnaire or one-by-one checklist. "
            "Facilitator-facing narratives (response_summary, overall_coverage_summary, next_best_question, "
            "reason_for_next_question, clarification_question) must never name enterprise-standard titles, "
            "statuses, findings, or alignment scores. Use neutral language only. "
